...
function quantityModal(itemId) {
    ...
    return `<div class="cart__modal--close">
            ...
            <div class="cart__quantity-modal--control">
                ...
                <input class="cart__modal-quantity" oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value < 1 || this.value === '') this.value = 1;" value="${item.quantity}" aria-label="현재 수량" />
