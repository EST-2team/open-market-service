...
function renderCartItem(items) {
    const orderBtn = document.querySelector(".cart__payment-btn--multi");
                        ...
                        <td class="cart__product-cell">
                            ...
                            <div class="cart__product-info">
                                ...
                                <p class="cart__delivery-info">
                                    <span class="sr-only">배송: </span>${item.product.shipping_method === "PARCEL" ? "택배배송" : "직접배송"} / ${item.product.shipping_fee.toLocaleString() + "원" || "무료배송"}
                                </p>
                            </div>
                        </td>
